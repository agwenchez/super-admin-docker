  ...
  return (
    <Fragment>
      <div className="sidebar-wrapper">
        ...
        <Link to={`/dashboard/`}>
          <h4 style={{ marginBottom: '-1.8%'}} >AFYA KWANZA</h4>
          </Link>
                  ...
                  MENUITEMS.map((Item, i) =>
                    <Fragment key={i}>
                      ...
                      {Item.Items.map((menuItem, i) =>
                        <li className="sidebar-list" key={i} style={{fontSize: '18px'}}>
                          {(menuItem.type === 'sub') ?
                            <a  className={`sidebar-link sidebar-title  ${menuItem.active ? 'active' : ''}`} onClick={() => setNavActive(menuItem)}>
                              <menuItem.icon />
                          ...
                          {menuItem.children ?
                            ...
                            <ul style={{fontSize: '18px'}} className="sidebar-submenu"
                                ...
                                return (
                                  <li style={{fontSize: '18px'}} key={index}>
                                    ...
                                    {(childrenItem.type === 'sub') ?
                                      <a style={{fontSize: '18px'}} className={`${childrenItem.active ? 'active' : ''}`}  onClick={() => toggletNavActive(childrenItem)}>{props.t(childrenItem.title)}
